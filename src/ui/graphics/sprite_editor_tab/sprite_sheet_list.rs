...
impl SpriteSheetList {
    pub(crate) fn draw(&mut self, ui: &mut Ui, rom: &mut pikuseru::core::Pikuseru, scale: f32, texture_id: TextureId) {       
            ui.group(|ui| {
    ...
    pub fn draw_sprite_preview(&mut self, ui: &mut Ui, rom: &mut pikuseru::core::Pikuseru, idx: usize, scale: f32, texture_id: TextureId) {
