use pikuseru::audio::tracker::chain::ChainId;
use pikuseru::audio::instruments::instrument_data_definition::InstrumentId;
use pikuseru::audio::notes::note::NoteId;
use pikuseru::audio::tracker::phrase::PhraseId;
use pikuseru::audio::consts::{CHAINS_MAX_COUNT, INSTRUMENTS_MAX_COUNT, PHRASES_MAX_COUNT, TOTAL_NOTES_COUNT};
